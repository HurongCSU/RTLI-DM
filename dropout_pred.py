...
from data_organize.utils import get_split, get_images, data_loader_tln, NET_SIZE
...
if __name__ == '__main__':
    ...
    all_pred = []
    for i in range(10):
        pred = model.predict(train_set[:2])
    ...
    print((np.array(max_means)).argsort()[:10])
