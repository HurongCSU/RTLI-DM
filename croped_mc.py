...
class TrainDCNN:
    def __init__(self, optimizer=tf.keras.optimizers.SGD(lr=0.01, decay=0.00001)):
        ...
        self.save_model = ModelCheckpoint(
            "./model/T2_20231212_tln_croped_dense_mc.h5",
            monitor='val_loss',
            verbose=1,
            mode="min",
            save_best_only=True)
    ...
    def training(self, _train_set, _y_train, _val_set, _y_val):
        ...
        self.model = keras.applications.densenet.DenseNet121(input_shape=(NET_SIZE, NET_SIZE, 3),
